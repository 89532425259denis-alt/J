...
class AggregateImageSearcher:
    ...
    async def _collect(
        ...
        count: int,
        *,
        result_filter: Optional[Callable[[ImageDict], bool]] = None,
        should_avoid: Optional[Callable[[str], bool]] = None,
        avoid_key: Optional[Callable[[ImageDict], str]] = None,
        already: Optional[list[ImageDict]] = None,
    ) -> list[ImageDict]:

...
"""ГОСТ-АССИСТЕНТ v2.1 — ТОЧНЫЕ СТРАНИЦЫ + ЛИМИТ 1 РАЗ В 5 ДНЕЙ
...
4. Все базовые возможности v2.0 сохранены: красивые заголовки глав,
...
async def _expand_blocks_by_chars(
    ...
    style_sys = (
        ...
        "СТРОГО: без markdown (никаких **, ##, ---, ```), без сносок [1] [2] [3], "
    ...
    for i in candidates:
        ...
        while need > 100 and attempts < max_attempts:
            ...
            user_prompt = (
                ...
                f"исторический контекст, мнения учёных (упоминай имена в тексте, "
                f"не сносками), сравнения, классификации.\n"

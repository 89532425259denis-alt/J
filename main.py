...
"""ГОСТ-АССИСТЕНТ v2.3 — ИСПРАВЛЕНИЕ ДУБЛЕЙ, ОБРЫВОВ И ПОДГОНКИ СТРАНИЦ
    ...
    async with GEN_SEMAPHORE:
        ...
        try:
            ...
            for it in range(max_iters):
                ...
                chars_per_page = max(1700, int(CHARS_PER_PAGE * 1.50))
            ...
            if post_lo_pages and abs(post_lo_pages - target_pages) > 2:
                ...
                chars_per_page2 = max(1700, int(CHARS_PER_PAGE * 1.50))

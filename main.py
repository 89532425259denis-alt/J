    ...
    for i in candidates:
        ...
        while need > 100 and attempts < max_attempts:
            ...
            user_prompt = (
                ...
                f"Пиши 4–7 полных развёрнутых абзацев с:\n"
                f"- конкретными примерами, фактами, данными, кейсами по теме\n"
                f"- анализом и рассуждениями\n"
                f"- ссылками на источники [1], [2, с. 45] (минимум 2-3)\n"
                f"- терминологией дисциплины «{subject}»\n\n"
                f"Начинай сразу с продолжения мысли. Никаких заголовков, никаких «Продолжение», никаких списков.\n"
                f"Заканчивай полными мыслями.\n\n"
                f"Хвост уже написанного:\n...{tail}"
            )
